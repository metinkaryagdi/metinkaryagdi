...
| **[CodeCraft.NET](https://github.com/metinkaryagdi/CodeCraft.NET)** | Adaptive .NET training platform — **Clean Architecture** ASP.NET Core 8 backend with a weighted daily-plan algorithm (spaced-repetition-style revision) that targets each learner's weak topics, plus a HackerRank-style isolated code execution engine. ~57 unit & integration tests. |
